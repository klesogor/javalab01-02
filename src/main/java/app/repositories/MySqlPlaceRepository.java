...
public class MySqlPlaceRepository extends AbstractSqlRepository implements PlaceRepositoryInterface {
    ...
    public MySqlPlaceRepository() throws DomainException {
        super();
    }

    public void save(Place entity) throws DatabaseException{
        try{
    ...
    private void insertPlace(Place entity) throws SQLException
    {
        ...
        statement.executeUpdate();
        entity.setId( dbConnection.prepareStatement("SELECT LAST_INSERTED_ID() id")
                .executeQuery().getInt("id"));
    }

    private void updatePlace(Place entity) throws SQLException
    {
